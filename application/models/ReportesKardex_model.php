    ...
    public function getDoctosByArticulo($Articulo, $fecha, $aFecha, $Texto_Mes_Anterior) {
        try {
            ...
            return $this->db->select("(SELECT $Texto_Mes_Anterior FROM articulos WHERE Clave = MA.Articulo) AS SaldoInicial,  "
                                    ...
                                    . "CASE "
                                    . "WHEN MA.TipoMov ='EXC' "
                                    . "THEN (select maq from ordencompra where folio = MA.OrdenCompra and tp = MA.Tp and articulo = MA.Articulo and proveedor = MA.Proveedor) "
                                    . "ELSE MA.Maq END AS Maq, "
                                    . "CASE "
                                    . "WHEN MA.TipoMov ='EXC' "
                                    . "THEN (select Sem from ordencompra where folio = MA.OrdenCompra and tp = MA.Tp and articulo = MA.Articulo and proveedor = MA.Proveedor) "
