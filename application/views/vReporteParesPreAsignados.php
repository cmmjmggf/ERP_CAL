<div class="modal " id="mdlReporteParesPreAsignados"  role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Pares pre-asignados</h5>
...
<script>
    ...
    $(document).ready(function () {
        mdlReporteParesPreAsignados.on('shown.bs.modal', function () {
            ...
            mdlReporteParesPreAsignados.find('#Ano').focus();
        });

        mdlReporteParesPreAsignados.find('#btnImprimir').on("click", function () {
            HoldOn.open({theme: 'sk-bounce', message: 'ESPERE...'});

            var frm = new FormData(mdlReporteParesPreAsignados.find("#frmExplosion")[0]);

            $.ajax({
                url: base_url + 'index.php/ReportesProduccionJasper/onReporteParesPreAsignados',
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
        ...
        mdlReporteParesPreAsignados.find("#Ano").change(function () {
            if (parseInt($(this).val()) < 2015 || parseInt($(this).val()) > 2025 || $(this).val() === '') {
                swal({
                    ...
                    mdlReporteParesPreAsignados.find("#Ano").val("");
                    mdlReporteParesPreAsignados.find("#Ano").focus();
                });
            }
        });
        mdlReporteParesPreAsignados.find("#Maq").change(function () {
            onComprobarMaquilas($(this));
        });
        mdlReporteParesPreAsignados.find("#aMaq").change(function () {
            onComprobarMaquilas($(this));
        });
        mdlReporteParesPreAsignados.find("#Sem").change(function () {
            var ano = mdlReporteParesPreAsignados.find("#Ano");
            onComprobarSemanasProduccion($(this), ano.val());
        });
        mdlReporteParesPreAsignados.find("#aSem").change(function () {
            var ano = mdlReporteParesPreAsignados.find("#Ano");
            onComprobarSemanasProduccion($(this), ano.val());
        });
    });
