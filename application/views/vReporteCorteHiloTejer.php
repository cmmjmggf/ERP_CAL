...
<script>
    ...
    $(document).ready(function () {
        ...
        mdlReporteCorteHiloTejer.find('#btnImprimir').on("click", function () {
            var t_precio = mdlReporteCorteHiloTejer.find('#Precio').val();
            if (t_precio !== '') {
                ...
                swal({
                    ...
                    mdlReporteCorteHiloTejer.find('#Precio')[0].selectize.focus();
                });
            }
        });
        ...
        mdlReporteCorteHiloTejer.find("#aMaq").change(function () {
            onComprobarMaquilas($(this));
        });
        ...
        mdlReporteCorteHiloTejer.find("#aSem").change(function () {
            var ano = mdlReporteCorteHiloTejer.find("#Ano");
            onComprobarSemanasProduccion($(this), ano.val());
        });
    });
