<div class="card m-3 animated fadeIn" id="pnlTablero">
    <div class="card-header" align="center">
        <h3 class="font-weight-bold">Pares asignados y terminados por laser</h3>
    </div>
    <div class="card-body">
        <div class="row" align="center">
            ...
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-2">
                ...
                <input type="text" id="MaquilaInicial" name="MaquilaInicial" class="form-control form-control-sm numbersOnly" autofocus="">
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-2">
                <label>A la maquila</label>
                <input type="text" id="MaquilaFinal" name="MaquilaFinal" class="form-control form-control-sm numbersOnly" autofocus="">
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-2">
                <label>De la semana</label>
                <input type="text" id="SemanaInicial" name="SemanaInicial" class="form-control form-control-sm  numbersOnly">
            </div>
            <div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-2">
                <label>A la semana</label>
                <input type="text" id="SemanaFinal" name="SemanaFinal" class="form-control form-control-sm  numbersOnly">
            </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        btnAceptar.click(function () {
            ...
            if (MaquilaInicial.val() && MaquilaFinal.val() && SemanaInicial.val() && SemanaFinal.val() && Anio.val()) {
                HoldOn.open({
                    theme: 'sk-cube',
                    message: 'Por favor espere...'
                });
                $.post('<?php print base_url('ParesAsignadosLaser/getParesAsignadosLaser'); ?>', {
                ...
                swal('ATENCIÓN', 'TODOS LOS CAMPOS SON REQUERIDOS', 'warning').then((value) => {
                    if (MaquilaInicial.val()) {
                        MaquilaInicial.focus();
                    } else if (MaquilaFinal.val()) {
                        MaquilaFinal.focus();
                    } else if (SemanaInicial.val()) {
                        SemanaInicial.focus().select();
                    } else if (SemanaFinal.val()) {
                        SemanaFinal.focus().select();
                    } else if (Anio.val()) {
                        Anio.focus().select();
                    }
                    btnAceptar.attr('disabled', false);
