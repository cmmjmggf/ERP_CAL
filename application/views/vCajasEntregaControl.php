<div class="modal " id="mdlCajasEntregaControl"  role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Cajas a Entregar por Control</h5>
...
<script>
    ...
    $(document).ready(function () {
        mdlCajasEntregaControl.on('shown.bs.modal', function () {
            ...
            mdlCajasEntregaControl.find('#FechaFin').val(getToday());
            mdlCajasEntregaControl.find('#FechaIni').focus();
        });
        mdlCajasEntregaControl.find('#btnImprimir').on("click", function () {
            HoldOn.open({theme: 'sk-bounce', message: 'ESPERE...'});
            var frm = new FormData(mdlCajasEntregaControl.find("#frmCaptura")[0]);
            $.ajax({
                url: base_url + 'index.php/ReporteCajasEntregaControl/onReporteCajasEntregaXControl',
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
