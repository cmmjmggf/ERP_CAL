<div class="card mx-3" id="pnlTablero">
    ...
    <div class="card-body" style="padding-top: 5px">
        <div class="row" style="padding-left: 15px">
            ...
            <div class="col-12">
                <ul class="nav  justify-content-center nav-tabs" id="TAB_PIELES_FORROS_TEXTILES_SINTETICOS" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="pieles-tab" data-toggle="tab" href="#pieles" role="tab" aria-controls="pieles" aria-selected="true">PIELES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="forros-tab" data-toggle="tab" href="#forros" role="tab" aria-controls="forros" aria-selected="false">FORROS</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="textiles-tab" data-toggle="tab" href="#textiles" role="tab" aria-controls="textiles" aria-selected="false">TEXTILES</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="sinteticos-tab" data-toggle="tab" href="#sinteticos" role="tab" aria-controls="sinteticos" aria-selected="false">SINTÉTICOS</a>
                    </li>
                </ul>
                <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="pieles" role="tabpanel" aria-labelledby="pieles-tab">
                        <table id="tblPieles" class="table table-hover table-sm table-striped  compact nowrap" style="width: 100% !important;">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
                                    ...
                                    <th scope="col" class="sum">Cantidad</th>
                    ...
                    <div class="tab-pane fade" id="forros" role="tabpanel" aria-labelledby="forros-tab">
                        <table id="tblForros" class="table table-hover table-sm table-striped  compact nowrap" style="width: 100% !important;">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
                                    <th scope="col">Control</th>
                    ...
                    <div class="tab-pane fade" id="textiles" role="tabpanel" aria-labelledby="textiles-tab">
                        <table id="tblTextiles" class="table table-hover table-sm table-striped  compact nowrap" style="width: 100% !important;">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th>
                                    <th scope="col">Control</th>
                    ...
                    <div class="tab-pane fade" id="sinteticos" role="tabpanel" aria-labelledby="sinteticos-tab">
                        <table id="tblSinteticos" class="table table-hover table-sm table-bordered compact nowrap" style="width: 100% !important;">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Artículo</th><!--2-->
                                    <th scope="col">Descripción</th><!--3-->
                                    <th scope="col">U.M.</th><!--4-->

                                    <th scope="col">PIEZAS</th><!--5-->

                                    <th scope="col">Descripción</th><!--6-->
                                    <th scope="col">Grupo</th><!--7-->
                                    <th scope="col" class="sum">Cantidad</th><!--8-->
                                    <th scope="col">Semana</th><!--FILTRO-->
                                    <th scope="col">Fraccion</th><!--FILTRO-->
                                    <th scope="col">Pares</th><!--INFORMATIVO-->
                                </tr>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                        <table id="tblRegresos" class="table table-hover table-striped table-sm nowrap" style="width: 100%;">
                            <thead>
                                <tr>
                                    <th scope="col">ID</th><!--0-->
...
<script>
    ...
    $(document).ready(function () {
        ...
        $("#TAB_PIELES_FORROS_TEXTILES_SINTETICOS").on('shown.bs.tab', 'a[data-toggle="tab"]', function (e) {
            switch (e.currentTarget.id.replace("-tab", "")) {
                case "pieles":
                    console.log('OK PIELES');
                    Pieles.columns.adjust().draw();
                    break;
                case "forros":
                    console.log('OK FORROS');
                    Forros.columns.adjust().draw();
                    break;
                case "textiles":
                    console.log('OK TEXTILES');
                    Textiles.columns.adjust().draw();
                    break;
                case "sinteticos":
                    console.log('OK SINTETICOS');
                    Sinteticos.columns.adjust().draw();
                    break;
            }
        });
...
//                tblRegresos.DataTable().column(11).search('').draw();
    ...
    function getEmpleados() {
        $.getJSON('<?php print base_url('AsignaPFTSACXC/getEmpleados'); ?>').done(function (data) {
            $.each(data, function (k, v) {
...
<style>
    ...
    #tblPieles tbody tr td, #tblForros tbody tr td, #tblTextiles tbody tr td, #tblSinteticos tbody tr td {
