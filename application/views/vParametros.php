<div class="col-12">
    <div id="MnuBlock" class="col-12 row justify-content-center mt-2" align="center">
        <div class="col-12 col-sm-6 col-md-6 col-lg-4 col-xl-2 m-2 animated bounceIn" onclick="onMenuDisplay('MenuProveedores');">
            <div class="card text-center">
                <div class="card-body">
                    <span class="fa fa-key fa-2x mt-5"></span>
                    <div class="card-footer"><h5>PROVEEDORES</h5>
                    </div>
                </div>
            </div>
        </div>
