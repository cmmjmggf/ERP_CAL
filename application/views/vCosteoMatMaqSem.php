<div class="modal " id="mdlCosteoMatMaq"  role="dialog">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Vales de Material por Maq-Sem</h5>
...
<script>
    var mdlCosteoMatMaq = $('#mdlCosteoMatMaq');
    ...
    $(document).ready(function () {
        ...
        mdlCosteoMatMaq.on('shown.bs.modal', function () {
            ...
            mdlCosteoMatMaq.find('#Ano').focus();
        });
        mdlCosteoMatMaq.find("#Ano").change(function () {
            if (parseInt($(this).val()) < 2015 || parseInt($(this).val()) > 2025 || $(this).val() === '') {
                swal({
                    ...
                    mdlCosteoMatMaq.find("#Ano").val("");
                    mdlCosteoMatMaq.find("#Ano").focus();
                });
            }
        });
        mdlCosteoMatMaq.find('#btnImprimir').on("click", function () {

            HoldOn.open({theme: 'sk-bounce', message: 'ESPERE...'});
            var frm = new FormData(mdlCosteoMatMaq.find("#frmCaptura")[0]);


            $.ajax({
                url: base_url + 'index.php/ReportesMaterialesJasper/onReporteCosteoMatMaqSem',
                type: "POST",
                cache: false,
                contentType: false,
                processData: false,
                ...
                if (data.length > 0) {
                    ...
                    swal({
                        ...
                        mdlCosteoMatMaq.find('#Maq').focus();
                    });
                }
                HoldOn.close();
            }).fail(function (x, y, z) {
        ...
        mdlCosteoMatMaq.find("#Maq").change(function () {
            onComprobarMaquilas($(this));
        });
        mdlCosteoMatMaq.find("#Sem").change(function () {
