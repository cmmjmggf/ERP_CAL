...
<script>
    ...
    $(document).ready(function () {
        mdlAvanceProduccionPorDepto.on('shown.bs.modal', function () {
            ...
            getDeptos();
            mdlAvanceProduccionPorDepto.find('#Ano').focus();
        });
        mdlAvanceProduccionPorDepto.find('#btnImprimir').on("click", function () {
        ...
        mdlAvanceProduccionPorDepto.find("#Ano").change(function () {
            if (parseInt($(this).val()) < 2015 || parseInt($(this).val()) > 2025 || $(this).val() === '') {
                swal({
                    ...
                    mdlAvanceProduccionPorDepto.find("#Ano").val("");
                    mdlAvanceProduccionPorDepto.find("#Ano").focus();
                });
            }
        });
        mdlAvanceProduccionPorDepto.find("#Maq").change(function () {
