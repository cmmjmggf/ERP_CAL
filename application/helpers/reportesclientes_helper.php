...
class PDFAntiguedadCliente815 extends FPDF {
    ...
    function Header() {
        ...
        $this->Cell(18, 3.5, '', 1/* BORDE */, 0, 'C');
        $this->SetX($this->GetX());
        $this->Cell(9, 3.5, '', 1/* BORDE */, 0, 'C');
        /* ENCABEZADO DETALLE TITULOS */
        $anchos = array(5/* 1 */, 9/* 2 */, 12/* 3 */, 12/* 4 */, 18/* 5 */, 18/* 6 */, 18/* 7 */, 7/* 8 */,
            18/* 9 */,
            18/* 10 */,
            18/* 11 */,
            18/* 12 */,
            ...
            18/* 15 */,
            9/* 16 */);
        $aligns = array('C', 'C', 'C', 'C', 'R', 'R', 'R', 'C', 'R', 'R', 'R', 'R', 'R', 'R', 'R', 'C');
        $this->SetWidths($anchos);
        $this->SetAligns($aligns);
