...
class PDFSalida extends FPDF {
    ...
    function Header() {
        ...
        $this->SetX(36);
        $this->Cell(60, 4, utf8_decode("Costeo de materiales (Salida del almacén)"), 0/* BORDE */, 1, 'L');



        $this->SetFont('Calibri', 'B', 10);
        $this->SetX(36);
        $this->Cell(9, 4, utf8_decode("Doc. "), 0/* BORDE */, 0, 'L');
        $this->SetX(45);
        $this->SetFont('Calibri', '', 10);
        $this->Cell(30, 4, utf8_decode($this->getDoc()), 0/* BORDE */, 0, 'L');
        $this->SetX(75);
        $this->SetFont('Calibri', 'B', 10);
        $this->Cell(5, 4, 'Tp: ', 0/* BORDE */, 0, 'L');
        $this->SetX(80);
        $this->SetFont('Calibri', '', 10);
        $this->Cell(5, 4, utf8_decode($this->getTp()), 0/* BORDE */, 0, 'L');
        $this->SetX(85);
        $this->SetFont('Calibri', 'B', 10);
        $this->Cell(10, 4, 'Maq: ', 0/* BORDE */, 0, 'L');
        $this->SetX(95);
        $this->SetFont('Calibri', '', 10);
        $this->Cell(10, 4, utf8_decode($this->getMaq()), 0/* BORDE */, 0, 'L');
        $this->SetX(105);
        $this->SetFont('Calibri', 'B', 10);
        $this->Cell(10, 4, 'Sem: ', 0/* BORDE */, 0, 'L');
        $this->SetX(115);
        $this->SetFont('Calibri', '', 10);
        ...
        $this->Row(array('', utf8_decode('Artículo'), 'Cant.', 'U.M.', 'Precio', 'Subtotal', 'Fecha', 'Doc. Ent'));
