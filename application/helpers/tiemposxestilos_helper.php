...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $pos = array(37.5/* 0 */, 47.5/* 1 */, 62.5/* 2 */, 72.5/* 3 */, 97.5/* 4 */, 200/* 5 */, 215/* 6 */);
        ...
        /* LINEA */
        $this->SetFont('Calibri', 'BI', 12);
        $this->SetY(5);
        $this->SetX($pos[0]);
        $this->Cell(115, $alto_celda, utf8_decode("Tiempos por estilo departamento"), 1/* BORDE */, 0, 'C', 1);
        
        $this->SetFont('Calibri', 'B', 8);
        $this->SetY($base);
        $this->SetX($pos[0]);
        $this->Cell(10, $alto_celda, utf8_decode("Linea "), 1/* BORDE */, 0, 'L', 1);
        $this->SetX($pos[1]);
        $this->Cell(50, $alto_celda, utf8_decode($this->getLinea()), 1/* BORDE */, 1, 'L', 0);

        /* ESTILO */
        $this->SetX($pos[0]);
        $this->Cell(10, $alto_celda, utf8_decode("Estilo"), 1/* BORDE */, 0, 'L', 1);
        $this->SetX($pos[1]);
        $this->Cell(50, $alto_celda, utf8_decode($this->getEstilo()), 1/* BORDE */, 0, 'L', 0);

        /* FECHA IMPRESION */
        $this->SetY($base);
        $this->SetX($pos[4]);
        $this->Cell(10, $alto_celda, 'Imp.', 1/* BORDE */, 0, 'C', 1);
        $this->SetX($pos[4] + 10);
        $this->Cell(45, $alto_celda, Date('d/m/Y h:i:s a'), 1/* BORDE */, 0, 'C', 0);
...
//________________ Fonction encodage et dessin du code 128 _____________________
    function Code128($x, $y, $code, $w, $h) {
        ...
        $check = ord(isset($crypt[0]) ? $crypt[0] : "");                                                   // calcul de la somme de contrôle
