            ...
            foreach ($Grupos as $key => $G) {
                ...
                foreach ($Detalle as $key => $D) {
                    ...
                    if ($G->Clave === $D->ClaveGrupo) {
                        ...
                        $pdf->SetY($pdf->GetY());
                        $pdf->SetX(8);
                        $pdf->Cell(11, 3, utf8_decode($D->Codigo), 'B'/* BORDE */, 0, 'R');
                        $pdf->SetX($pdf->GetX());
                        $pdf->Cell(61, 3, mb_strimwidth(utf8_decode($D->Articulo), 0, 53, ""), 'B'/* BORDE */, 0, 'L');
                        $pdf->SetX($pdf->GetX());
                        $pdf->Cell(15, 3, utf8_decode($D->Unidad), 'B'/* BORDE */, 0, 'C');
                        $pdf->SetX($pdf->GetX());
                        $pdf->Cell(16, 3, ($D->MesAnterior <> 0) ? number_format($D->MesAnterior, 2, ".", ",") : '', 1/* BORDE */, 0, 'R');
                        $pdf->SetX($pdf->GetX());
                        $pdf->Cell(16, 3, ($D->Entradas <> 0) ? number_format($D->Entradas, 2, ".", ",") : '', 1/* BORDE */, 0, 'R');
                        $pdf->SetX($pdf->GetX());
                        $pdf->Cell(16, 3, ($D->Salidas <> 0) ? number_format($D->Salidas, 2, ".", ",") : '', 1/* BORDE */, 0, 'R');
                        $pdf->SetX($pdf->GetX());
                        $pdf->Cell(16, 3, ($Actual <> 0) ? number_format($Actual, 2, ".", ",") : '', 1/* BORDE */, 0, 'R');
                        $pdf->SetX($pdf->GetX());
                        $pdf->Cell(13, 3, utf8_decode($D->Codigo), 'B'/* BORDE */, 0, 'R');
                        $pdf->SetX($pdf->GetX());
                        $pdf->Cell(16, 3, ($D->MesActual <> 0) ? number_format($D->MesActual, 2, ".", ",") : '', 1/* BORDE */, 0, 'R');
                        $pdf->SetX($pdf->GetX());
                        $pdf->SetFont('Calibri', 'B', 7.5);
                        $pdf->SetTextColor(197, 43, 9);
                        $pdf->Cell(16, 3, ($Diferencia <> 0) ? number_format($Diferencia, 2, ".", ",") : '', 1/* BORDE */, 0, 'R');
                        $pdf->SetX($pdf->GetX());
                        $pdf->SetFont('Calibri', '', 7.5);
                        $pdf->SetTextColor(0, 0, 0);
                        $pdf->Cell(12, 3, '$' . number_format($D->Precio, 2, ".", ","), 1/* BORDE */, 0, 'R');
                        $pdf->SetX($pdf->GetX());
                        $pdf->Cell(19, 3, ($Pre_Actual <> 0) ? '$' . number_format($Pre_Actual, 2, ".", ",") : '', 1/* BORDE */, 0, 'R');
                        $pdf->SetX($pdf->GetX());
                        $pdf->Cell(19, 3, ($Pre_Fisico <> 0) ? '$' . number_format($Pre_Fisico, 2, ".", ",") : '', 1/* BORDE */, 0, 'R');
                        $pdf->SetX($pdf->GetX());
                        $pdf->SetFont('Calibri', 'B', 7.5);
                        $pdf->SetTextColor(197, 43, 9);
                        $pdf->Cell(19, 3, ($Pre_Difer <> 0) ? '$' . number_format($Pre_Difer, 2, ".", ",") : '', 1/* BORDE */, 0, 'R');
                        $pdf->SetY($pdf->GetY() + 3);
                        $pdf->SetFont('Calibri', '', 7.5);
                        $pdf->SetTextColor(0, 0, 0);
...
//Gran totales
                ...
                $pdf->SetY($pdf->GetY());
                $pdf->SetX(8);
                $pdf->Cell(25, 3.5, 'Total por Grupo: ', 0/* BORDE */, 0, 'L');
                $pdf->SetX($pdf->GetX());
                $pdf->SetFont('Calibri', '', 7.5);
                $pdf->Cell(47, 3.5, utf8_decode($G->Clave . ' ' . $G->Nombre), 0/* BORDE */, 0, 'L');
                $pdf->SetX($pdf->GetX());
                $pdf->SetFont('Calibri', 'B', 7.5);
                $pdf->Cell(15, 3.5, '', 0/* BORDE */, 0, 'C');
                $pdf->SetX($pdf->GetX());
                $pdf->Cell(16, 3.5, number_format($Tot_Mes_Ant, 2, ".", ","), 0/* BORDE */, 0, 'R');
                $pdf->SetX($pdf->GetX());
                $pdf->Cell(16, 3.5, number_format($Tot_Entradas, 2, ".", ","), 0/* BORDE */, 0, 'R');
                $pdf->SetX($pdf->GetX());
                $pdf->Cell(16, 3.5, number_format($Tot_Salidas, 2, ".", ","), 0/* BORDE */, 0, 'R');
                $pdf->SetX($pdf->GetX());
                $pdf->Cell(16, 3.5, number_format($Tot_Actual, 2, ".", ","), 0/* BORDE */, 0, 'R');
                $pdf->SetX($pdf->GetX());
                $pdf->Cell(13, 3.5, '', 0/* BORDE */, 0, 'R');
                $pdf->SetX($pdf->GetX());
                $pdf->Cell(16, 3.5, number_format($Tot_Fisico, 2, ".", ","), 0/* BORDE */, 0, 'R');
                $pdf->SetX($pdf->GetX());
                $pdf->SetTextColor(197, 43, 9);
                $pdf->Cell(16, 3.5, number_format($Tot_Diferencia, 2, ".", ","), 0/* BORDE */, 0, 'R');
                $pdf->SetX($pdf->GetX());
                $pdf->SetTextColor(0, 0, 0);
                $pdf->Cell(12, 3.5, '', 0/* BORDE */, 0, 'R');
                $pdf->SetX($pdf->GetX());
                $pdf->Cell(19, 3.5, '$' . number_format($Tot_Act_Pre, 2, ".", ","), 0/* BORDE */, 0, 'R');
                $pdf->SetX($pdf->GetX());
                $pdf->Cell(19, 3.5, '$' . number_format($Tot_Fis_Pre, 2, ".", ","), 0/* BORDE */, 0, 'R');
                $pdf->SetX($pdf->GetX());
                $pdf->SetTextColor(197, 43, 9);
                $pdf->Cell(19, 3.5, '$' . number_format($Tot_Dif_Pre, 2, ".", ","), 0/* BORDE */, 0, 'R');
                $pdf->SetY($pdf->GetY() + 4);
                $pdf->SetFont('Calibri', '', 7.5);
                $pdf->SetTextColor(0, 0, 0);
            }
            ...
            $pdf->SetY($pdf->GetY());
            $pdf->SetX(8);
            $pdf->Cell(25, 3.5, '', 0/* BORDE */, 0, 'L');
            $pdf->SetX($pdf->GetX());
            $pdf->SetFont('Calibri', 'B', 7.5);
            $pdf->Cell(47, 3.5, 'Total general:', 0/* BORDE */, 0, 'R');
            $pdf->SetX($pdf->GetX());
            $pdf->Cell(15, 3.5, '', 0/* BORDE */, 0, 'C');
            $pdf->SetX($pdf->GetX());
            $pdf->Cell(16, 3.5, number_format($GTot_Mes_Ant, 2, ".", ","), 0/* BORDE */, 0, 'R');
            $pdf->SetX($pdf->GetX());
            $pdf->Cell(16, 3.5, number_format($GTot_Entradas, 2, ".", ","), 0/* BORDE */, 0, 'R');
            $pdf->SetX($pdf->GetX());
            $pdf->Cell(16, 3.5, number_format($GTot_Salidas, 2, ".", ","), 0/* BORDE */, 0, 'R');
            $pdf->SetX($pdf->GetX());
            $pdf->Cell(16, 3.5, number_format($GTot_Actual, 2, ".", ","), 0/* BORDE */, 0, 'R');
            $pdf->SetX($pdf->GetX());
            $pdf->Cell(13, 3.5, '', 0/* BORDE */, 0, 'R');
            $pdf->SetX($pdf->GetX());
            $pdf->Cell(16, 3.5, number_format($GTot_Fisico, 2, ".", ","), 0/* BORDE */, 0, 'R');
            $pdf->SetX($pdf->GetX());
            $pdf->SetTextColor(197, 43, 9);
            $pdf->Cell(16, 3.5, number_format($GTot_Diferencia, 2, ".", ","), 0/* BORDE */, 0, 'R');
            $pdf->SetX($pdf->GetX());
            $pdf->SetTextColor(0, 0, 0);
            $pdf->Cell(12, 3.5, '', 0/* BORDE */, 0, 'R');
            $pdf->SetX($pdf->GetX());
            $pdf->Cell(19, 3.5, '$' . number_format($GTot_Act_Pre, 2, ".", ","), 0/* BORDE */, 0, 'R');
            $pdf->SetX($pdf->GetX());
            $pdf->Cell(19, 3.5, '$' . number_format($GTot_Fis_Pre, 2, ".", ","), 0/* BORDE */, 0, 'R');
            $pdf->SetX($pdf->GetX());
            $pdf->SetTextColor(197, 43, 9);
            $pdf->Cell(19, 3.5, '$' . number_format($GTot_Dif_Pre, 2, ".", ","), 0/* BORDE */, 0, 'R');
            $pdf->SetY($pdf->GetY() + 4);
            $pdf->SetFont('Calibri', '', 7.5);
            $pdf->SetTextColor(0, 0, 0);
