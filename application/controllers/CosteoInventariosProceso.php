...
class CosteoInventariosProceso extends CI_Controller {
    ...
    public function onGenerarCostosInventarioProceso() {
        $this->CosteaInventariosProceso_model->onGenerarCostosInventarioProceso();
    }
    ...
    public function onAumentarPrecioFracciones() {
        try {
            ...
            if ($Todos === '1') {
                $this->CosteaInventariosProceso_model->onAumentaPrecioFracciones($this->input->post('Porcentaje'));
            } else {
                //verificar si esta bloqueado o no en tabla de estilos
                $Bloqueado = $this->CosteaInventariosProceso_model->onVerificarEstiloBloqueado($this->input->post('Estilo'));

                if ($Bloqueado[0]->Seguridad === '1') {
                    print '1';
                } else {
                    $this->CosteaInventariosProceso_model->onAumentaPrecioFraccionesXEstilo($this->input->post('Estilo'), $this->input->post('Porcentaje'));
                }
            }
        } catch (Exception $exc) {
            echo $exc->getTraceAsString();
    ...
    public function getFraccionesXDepartamento() {
        try {
            print json_encode($this->CosteaInventariosProceso_model->getFraccionesXDepartamento($this->input->get('Departamento')));
        } catch (Exception $exc) {
            echo $exc->getTraceAsString();
        }
    }
    ...
    public function getDepartamentos() {
        try {
            print json_encode($this->CosteaInventariosProceso_model->getDepartamentos());
        } catch (Exception $exc) {
            echo $exc->getTraceAsString();
        }
    }
    ...
    public function onComprobarExisteEstilo() {
        try {
            print json_encode($this->CosteaInventariosProceso_model->onComprobarExisteEstilo($this->input->get('Estilo')));
        } catch (Exception $exc) {
            echo $exc->getTraceAsString();
        }
    }
    ...
    public function getEstilos() {
        try {
            print json_encode($this->CosteaInventariosProceso_model->getEstilos());
        } catch (Exception $exc) {
            echo $exc->getTraceAsString();
        }
    }
    ...
    public function getFracciones() {
        try {
            print json_encode($this->CosteaInventariosProceso_model->getFracciones());
        } catch (Exception $exc) {
            echo $exc->getTraceAsString();
        }
    }
    ...
    public function getEstiloByID() {
        try {
            print json_encode($this->CosteaInventariosProceso_model->getEstiloByID($this->input->get('Estilo')));
        } catch (Exception $exc) {
            echo $exc->getTraceAsString();
        }
    }
    ...
    public function getFraccionesXEstiloDetalleByID() {
        try {
            print json_encode($this->CosteaInventariosProceso_model->getFraccionesXEstiloDetalleByID($this->input->get('Estilo')));
        } catch (Exception $exc) {
            echo $exc->getTraceAsString();
        }
    }
    ...
    public function onAgregar() {
        try {
            ...
            $ID = $this->CosteaInventariosProceso_model->onAgregar($data);
            print $ID;
        } catch (Exception $exc) {
            echo $exc->getTraceAsString();
        }
    ...
    public function onModificarDetalle() {
        try {
            ...
            $this->CosteaInventariosProceso_model->onModificar($this->input->post('ID'), $data);
        } catch (Exception $exc) {
            echo $exc->getTraceAsString();
        }
    }
    ...
    public function onEliminarFraccion() {
        try {
            $this->CosteaInventariosProceso_model->onEliminarFraccion($this->input->post('ID'));
        } catch (Exception $exc) {
            echo $exc->getTraceAsString();
        }
    }
    ...
    public function onImprimirFraccionesXEstilo() {
        $cm = $this->CosteaInventariosProceso_model;
